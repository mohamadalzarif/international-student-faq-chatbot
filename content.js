...
const faqData = {
   ...
   */
  "arrival":
    "AUC’s International Programs and Services Office (IPSO) registers visiting students before they arrive in Cairo – there is no online self‑registration for study‑abroad students. Make sure your passport is valid for at least six months beyond your arrival and carry your admission letter. Many nationalities (e.g. U.S., Canada, Australia and most EU) can purchase a one‑month tourist visa on arrival; others such as Polish, Portuguese and Finnish citizens must apply for an entry visa in advance. Once in Egypt, take the free AUC airport shuttle by emailing carpool@aucegypt.edu; show your acceptance letter and passport to board. International Student Orientation is held the week before classes; you will obtain your AUC ID card and student visa, take placement tests, complete late registration and learn about campus services. Orientation includes campus tours and guidance from International Peer Leaders, and an optional 20‑hour survival Arabic course for about USD $280. Keep emergency contacts handy but do not send personal documents through this chatbot.",
   ...
   */
  "visa":
    "Before departure, apply for a 90‑day entry visa at an Egyptian consulate and state that your purpose is study; some nationals can instead buy a one‑month tourist visa on arrival for about $25. Passports must be valid at least six months beyond arrival. After you arrive, some nationalities must register their passports within seven days and pay a small fee; all students must complete the Business Support Form and follow the Business Support Office’s (BSO) instructions. Government fees are roughly EGP 7 100 for tourist‑visa renewal, EGP 850 for a re‑entry visa and EGP 7 100 for a residency visa, with a late fine of EGP 1 685. Residency approvals are valid for up to four years and residency cards must be renewed annually. Always contact students.residency@aucegypt.edu for up‑to‑date guidance; do not share passport scans via this bot.",

  /**
   * Housing: describes the on‑campus housing process and off‑campus advice.
   */
  "housing":
    "First‑year students are required to live on campus through the First‑Year Residential Experience (FYRE) program. To apply for AUC housing, wait for an email from the Office of Residential Life announcing application dates. After securing admission, create and activate your AUC email account, then log into the StarRez portal with your AUC username to select a room and sign a housing contract. Continuing, graduate and exchange students follow the same portal procedure and will receive move‑in instructions and final housing requirements by email before the semester begins. On move‑in day, pick up your ID card, obtain your room key and learn about spare‑key policies; always follow housing guidelines. For off‑campus options, IPSO can suggest trusted resources, but you remain responsible for lease agreements.",
   ...
   */
  "registration":
    "IPSO registers visiting international students; you must submit a Preliminary Course Planning (PCP) form during the advising period listing your preferred courses. IPSO obtains departmental approval and enrols you – there is no self‑registration for study‑abroad students. Undergraduate visitors generally register during the early‑registration period and have a drop/add period; graduate students register during on‑site orientation. A full‑time load is 12–15 credits for undergraduates and 9 credits for graduate students. Overloads require approval and are limited to 18 credits for undergraduates and 12 credits for graduate students. Undergraduates may take 1000‑4000‑level courses and some 5100‑level courses; graduate visitors must take 5000‑ or 6000‑level courses but may include one 3‑credit Arabic language course if they complete the ALNG background form. PCP deadlines are usually 1 June for fall and 1 December for spring. Check the dynamic schedule and course catalogue and email ipso@aucegypt.edu with questions.",
   ...
   */
  "emergency":
    "For urgent assistance on campus, call AUC Security at +20 2 2615 4444; the medical clinic in New Cairo at +20 2 2615 4000; or the medical clinic at Tahrir Square at +20 2 2797 5000. The university doctor can be reached at 0128 000 1039 and the Facilities & Operations service center at +20 2 2615 2222. For environmental health and safety issues call +20 2 2615 4170/4180, and for IT emergencies call the Help Desk at +20 2 2615 1200. The campus emergency hotline is 19282 (19AUC). Public emergency numbers in Egypt include ambulance (123), civil defense (125), police (122), road emergencies (012 2111 0000) and tourism police (126). If you ever feel unsafe, contact these numbers immediately and follow instructions from campus security. This chatbot cannot handle emergencies.",
   ...
   */
  "contact":
    "The International Programs and Services Office (IPSO) is located in Room P126 of the Prince Alwaleed Bin Talal Bin Abdulaziz Alsaud building on the AUC campus. Office hours are 9:00 AM to 3:00 PM. You can email ipso@aucegypt.edu or call +20 2 2615 3612 for assistance with arrival, visa/residency, housing, registration and other concerns. For visa questions contact the Business Support Office at students.residency@aucegypt.edu. For airport transportation queries email carpool@aucegypt.edu. Remember that this chatbot provides general guidance only; always contact IPSO or the relevant AUC office for official assistance."
};
